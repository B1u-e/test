...
contract GamblingGameScript is Script {
    ...
    function run() public {
        ...
        GamblingGame(address(proxyGamblingGame)).initialize(
            admin,
            address(testToken),
            admin
        );
        ...
        console.log("gamblingGame deployed to:", address(gamblingGame));
        console.log(
            "proxyGamblingGame deployed to:",
            address(proxyGamblingGame)
        );
